      ...
      <div className="bg-[#EB9721] w-full px-5 relative">
        <div className="bg-[#EBCEA8] w-full px-5 py-10">
          <div className="flex justify-between items-center mb-9">
            ...
            <select className="border border-[#EB9721] text-gray-800 font-semibold py-2 px-4 rounded-md ml-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-10">
            ...
            <div className="bg-[#F3CA79] rounded-lg shadow-lg p-5">
              ...
              <p className="text-gray-600 mb-4">
                Match the elements shapes to their same elements.
              </p>
              <button
            ...
            <div className="bg-[#F3CA79] rounded-lg shadow-lg p-5">
              ...
              <p className="text-gray-600 mb-4">
                Simple but enjoying Math games with add, subtract and multiply
                symbol.
              </p>
              <button
            ...
            <div className="bg-[#F3CA79] rounded-lg shadow-lg p-5">
              ...
              <p className="text-gray-600 mb-4">
                Knowing the name of the picture make u know the name.
              </p>
              <button
