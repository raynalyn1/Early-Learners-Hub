...
import animalbg from "../../images/games/animalbg.png";
      ...
      {showIntro ? (
        <div className="intro-screen flex flex-col items-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="text-2xl mb-6 text-gray-700">
            Can you help unscramble the animal names? 🐾
          </p>
          <button
              ...
              {currentAnimal && (
                <div className="flex flex-col items-center ">
                  <div className="relative mb-6 border shadow-lg ">
                    ...
                    {/* Unscrambled letters */}
                    <div className="absolute top-0 left-0 flex flex-col items-start p-2 md:mt-[3rem] md:ml-[2rem]">
                      {currentAnimal.scrambled
                        .split("")
                        .map((letter, index) => (
                          <div
                            key={index}
                            className="border-2 border-gray-300 bg-gray-100 p-4 m-1 w-12 h-12 flex items-center justify-center text-purple-600 text-3xl font-bold"
                          >
                            {letter}
                          </div>
                        ))}
